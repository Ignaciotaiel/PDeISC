...
import { renderClock } from './reloj.js?v=2';
import { renderPalette } from './paleta.js?v=2';
import { setupChildCounter } from './hijos.js';
...
export const renderComponent = (name) => {
  ...
  if (components[name]) {
    ...
    if (card) {
      ...
      // En Ejercicio 3 agregamos el contador de hijos a cada componente
      setupChildCounter(card);
    }
  }
};
